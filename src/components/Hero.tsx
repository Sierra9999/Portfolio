  ...
  return (
    <section className="hero">
      <div className="hero__content">
        <h1 className="hero__name slide-from-left"> 
          Mateo Sierra <span className="bounce red-gradient">.</span>
        </h1>
        ...
        <h1 className="hero__location slide-from-right">Based in <span className="red-gradient">Medellin.</span></h1>
